...
public class Aluno {
    ...
    public Aluno(String nome_aluno, String num_matricula, String nome_curso, String[] nome_disciplinas, double[] notas1, double[] notas2, double[] notas3, double[] notas4) {
