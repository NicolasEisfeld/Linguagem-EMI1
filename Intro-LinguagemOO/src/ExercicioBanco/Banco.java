    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= N; i++) {
            ...
            while (true) {
                ...
                tipoConta = dado.nextInt();
                if (tipoConta == 1 || tipoConta == 2) {
                    break; // Sai do loop se o valor for válido
                } else {
                    System.out.println("Tipo de conta inválido. Por favor, digite 1 para Corrente ou 2 para Poupança.");
                }
            }
            ...
            if (tipoConta == 1) {
                // Conta Corrente
                ContaCorrente Usuario = new ContaCorrente(i, nome, saldo);
                double limite = 0.05;
                Usuario.setLimite(limite); // Define o limite para a conta corrente
            } else {
                // Conta Poupança
                ContaPoupanca Usuario = new ContaPoupanca(i, nome, saldo);
